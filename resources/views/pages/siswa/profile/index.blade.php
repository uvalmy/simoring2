                    ...
                    <form id="updateData">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control" id="nama" name="nama"
                                value="{{ auth('siswa')->user()->nama }}">
                            <small class="invalid-feedback" id="errornama"></small>
                        </div>
                        <div class="form-group mb-3">
                            <label for="telepon" class="form-label">Telepon <span class="text-danger">*</span></label>
                            <input type="text" class="form-control" id="telepon" name="telepon"
                                value="{{ auth('siswa')->user()->telepon }}">
                            <small class="invalid-feedback" id="errortelepon"></small>
                        </div>
                        <div class="form-group mb-3">
                            <label for="alamat" class="form-label">Alamat <span class="text-danger">*</span></label>
                            <textarea class="form-control" rows="4" id="alamat" name="alamat">{{ auth('siswa')->user()->alamat }}</textarea>
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#updatePassword").submit(function(e) {
                ...
                e.preventDefault();
                const url = `{{ route('siswa.updatePassword') }}`;
                const data = new FormData(this);
