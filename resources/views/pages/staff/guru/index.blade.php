...
@section('main')
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table id="guru-table" class="table table-bordered table-striped" width="100%">
                    <thead>
                        <tr>
                            <th width="5%">#</th>
                            <th>Nik</th>
    ...
    @include('pages.staff.guru.modal')
@endsection
...
@push('scripts')
    ...
    <script>
        $(document).ready(function() {
            datatableCall('guru-table', '{{ route('staff.guru.index') }}', [{
                    data: 'DT_RowIndex',
                    name: 'DT_RowIndex'
                },
                {
            ...
            $("#saveData").submit(function(e) {
                ...
                let url = "{{ route('staff.guru.store') }}";
